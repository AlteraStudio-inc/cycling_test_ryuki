...
export function ShiftCalendarScreen() {
  ...
  const handleSave = async () => {
    ...
    const { error } = await supabase.rpc("admin_add_shift", {
      ...
      p_start_time: pickedStart === "24:00" ? "00:00" : pickedStart,
      p_end_time: pickedEnd === "LAST" ? "23:59" : pickedEnd === "24:00" ? "00:00" : pickedEnd,
            ...
            <ScrollView contentContainerStyle={styles.modalContent}>
              ...
              {step === "detail" && (
                <>
                  ...
                  <TimePicker label="開始時間" value={pickedStart} onChange={setPickedStart} />
                  <TimePicker label="終了時間" value={pickedEnd} onChange={setPickedEnd} showLast />
